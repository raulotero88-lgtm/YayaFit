...
- **Identidad (REST /settings):** título "YayaFit", tagline "Tu segunda juventud empieza aquí", zona horaria Europe/Madrid, fecha `j \d\e F \d\e Y`, hora `H:i`, email admin → **contacto.yayafit@gmail.com** (corregido el mismo día: primero se puso el personal de Raúl y lo descartó; ⚠️ hay que **crear ese buzón de Gmail** si no existe aún, ahí llegan el formulario de contacto y los avisos de WordPress), pingbacks cerrados.
